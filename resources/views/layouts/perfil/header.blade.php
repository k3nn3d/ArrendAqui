       ...
       <header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        ...
        <div class="m-header">
          ...
          <a href="{{ route('home') }}" class="b-brand">
            ...
            <img src="tmp/dist/assets/images/logo.png" alt="" class="logo">
            <img src="tmp/dist/assets/images/logo-icon.png" alt="" class="logo-thumb">
            ============ -->
            <span style="font-size: 19pt;"> <span style="color: rgb(48, 48, 184)">Arrend'</span><span style="color: rgb(30, 116, 30)">Aqui</span> </span>
          </a>
