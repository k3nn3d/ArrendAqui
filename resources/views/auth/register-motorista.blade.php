                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <form  method="POST" action="{{ route('register') }}" class="user" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    <input type="number" class="form-control form-control-user" @error('telefone') is-invalid @enderror value="{{ old('telefone') }}" name="telefone" id="exampleEmail"
                                        placeholder="Telefne" required>
                                        {{ ($errors->has('telefone')) ? $errors->first('telefone'): '' }}
                                </div>
                                <div class="form-group mb-3">
                                    BI
                                    <input type="file" class="form-control form-control-user" @error('bi') is-invalid @enderror value="{{ old('bi') }}" name="bi" id="exampleEmail"
                                        placeholder="BI" required>
                                        {{ ($errors->has('bi')) ? $errors->first('bi'): '' }}
                                </div>
                                <div class="form-group mb-3">
                                    Carta de Condução
                                    <input type="file" class="form-control form-control-user" @error('habilitacoes') is-invalid @enderror value="{{ old('habilitacoes') }}" name="habilitacoes" id="exampleEmail"
                                        placeholder="Carta de Condução" required>
                                        {{ ($errors->has('habilitacoes')) ? $errors->first('habilitacoes'): '' }}
                                </div>
                                <div class="form-group row mb-3">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <input type="hidden" name="vc_tipo_utilizador" value="3">
