                        ...
                        <div class="p-5">
                            ...
                            <form  method="POST" action="{{ route('register') }}" class="user" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-user" @error('iban') is-invalid @enderror value="{{ old('iban') }}" name="iban" id="exampleEmail"
                                ...
                                <input type="hidden" name="vc_tipo_utilizador" value="4">
