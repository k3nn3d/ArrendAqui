...
<div class="container">
  <div class="row justify-content-center align-items-center">
	<div class="col-lg-9 text-center mt-5">
	  <h1 class="heading" data-aos="fade-up">Pagamentos</h1>
	  <nav
            ...
            <hr>
              <div class="card mb-5">
                ...
                <div class="card-body">  
                  ...
                  <div> 
                    <button class="prev btn" >Saques</button>    <button class="next btn">Pagamentos</button>  
                    </div>         
                  <div class="table-responsive">
                    ...
                    <div id="step-2" class="step">
                      ...
                      @endforeach
                        ...
                        @empty($user2)
                          <tr>
                            <td colspan="7" style="text-align: center"> Não há pagamentos</td>
                          </tr>
                        @endempty
